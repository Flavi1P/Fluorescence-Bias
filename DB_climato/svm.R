...
dir_data <- "/home/sauzede/Documents/R/DATA/PIGMENTS/FLAVIEN_RUN/"
dir_plot <- "/home/sauzede/Documents/R/PLOT/FLAVIEN_NN/"
...
ggplot(data = DATABASE_VALID2[DATABASE_VALID2$depth<1000,], aes(x = Estimated_ratio, y = Obs_ratio, colour=log(depth))) + geom_point()
